...
@Tag(
        name = "CRUD REST APIs for Loans in JainBank",
        description = "CRUD REST APIs in JainBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside JainBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
